...
Distinct from the in-game runtime above: this is the documentation surface (`SkillView` + `SkillModal`) that renders a hero's skill text, filter chips, and optional commentary.
