...
import { gridStyles } from './Isabella.data'
</script>
  ...
  <SkillSnippets>
    <template #ultimate>
      <SkillSnippet title-key="guide-targeting">
        ...
        <ul>
          <li>
            <strong>Ally Team Isabella:</strong> Scans ally positions starting from the frontmost
            row, from left to right (highest tile ID to lowest), targeting the first teammate found.
          </li>
          <li>
            <strong>Enemy Team Isabella:</strong> Scans enemy positions in reverse order, from right
            to left (lowest tile ID to highest), targeting the first teammate found.
          </li>
        </ul>
