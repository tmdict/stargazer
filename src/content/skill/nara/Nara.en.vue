  ...
  <SkillSnippets>
    <template #skill2>
      <SkillSnippet title-key="guide-targeting">
        <p>
          Nara first checks her symmetrical tile (the mirror position across the grid's center). If
          an opponent is there, they become the target.
        </p>
        <p>
          If the symmetrical tile is empty, Nara searches for the nearest opponent in a clockwise
