...
import { gridStyles } from './Talene.data'
</script>
      ...
      <SkillSnippet title-key="guide-targeting">
        ...
        <ul>
          <li>
            ...
            from left to right (highest tile ID to lowest), targeting the first teammate found.
          </li>
          <li>
            <strong>Enemy Team Talene:</strong> Scans enemy positions in reverse order, from right
