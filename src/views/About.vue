  ...
  <main>
    <div class="section">
      <div class="content">
        ...
        <p>
          Stargazer is a team planning tool for AFK Journey arena battles. It lets you experiment
          with different hero positions and team compositions on a hexagonal grid, just like the
