...
describe('Grid', () => {
  ...
  describe('Character Operations', () => {
    describe('character query methods', () => {
      ...
      it('should find character hex', () => {
        ...
        expect(grid.findCharacterHex(200, Team.ENEMY)).toBe(30)
        expect(grid.findCharacterHex(999, Team.ALLY)).toBeNull()
      })
    ...
    describe('character placement and removal', () => {
      ...
      it('should auto place character on random available tile', () => {
        ...
        const hex = grid.findCharacterHex(100, Team.ALLY)
  ...
  describe('Companion System', () => {
    ...
    it('should manage companion links', () => {
      ...
      // Get companions from both teams to verify total
      const totalCompanions = new Set([
        ...grid.getCompanions(100, Team.ALLY),
        ...grid.getCompanions(100, Team.ENEMY),
      ])
      expect(totalCompanions.size).toBe(2) // 10100 and 10101
    })
    ...
    it('should clear companion links', () => {
      ...
      grid.clearCompanionLinks(100, Team.ENEMY)
      expect(grid.getCompanions(100, Team.ENEMY).size).toBe(0)
    })
  })
